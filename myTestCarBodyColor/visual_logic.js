...
registerOnClick('btnblue', false, false, [0,1,2], function() {
  assignMat('car', 'blue');
}, function() {});
registerOnClick('btngreen', false, false, [0,1,2], function() {
  assignMat('car', 'green');
}, function() {});
registerOnClick('btnred', false, false, [0,1,2], function() {
  assignMat('car', 'red');
}, function() {});
